...
<body>
	<div class="container">
		...
		<div class = "row" >
			<div class = "col-xs-12" id = "great_font">
				<span class="glyphicon glyphicon-star"></span>精彩活动
			</div>
		</div>
		<div class = "row class_border ">
			<div class = "protype">
				<div class = "col-xs-8 pro_font">比赛</div>
				<div class = "col-xs-4 down_cla"></div>
			</div>
		...
		<div class = "row bottom">
			<div class = "col-xs-3"><a href = "http://localhost/activity/index.php?/index/index" class = "btn btn-primary btn-sm disabled" role = "button">活动推荐</a></div>
