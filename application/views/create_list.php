...
<head>
	...
	<link href = "/activity/style/join_list/css/join_list.css" type = "text/css" rel = "stylesheet"></link>
	...
	<script	src = "/activity/style/join_list/js/join_list.js"></script>
</head>
<body> 
	<div class = "container">
		<div class = "row" id = "top">
			<div class = "col-xs-12" >
				...
				<div class = "col-xs-9" id = "top_font">已发布</div>
			</div>
		</div>
		<div class = "row">
			<div class = "content_border1 ">
				...
				<div class = "button_delete"><button class = "btn btn-primary">取消活动</button></div>
			</div>
